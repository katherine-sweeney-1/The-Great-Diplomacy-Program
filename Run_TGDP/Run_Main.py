import sys
import os
sys.path.append(os.path.join("/home/katherine/Documents/TGDP_Code/The-Great-Diplomacy-Program/data/Data_Set_1"))
from Commanders_1 import cmdrs_1
from Commands_1 import cmds_1
from Units_1 import units_1
sys.path.append(os.path.join("/home/katherine/Documents/TGDP_Code/The-Great-Diplomacy-Program/data/Data_Set_2"))
from Commanders_2 import cmdrs_2
from Commands_2 import cmds_2
from Units_2 import units_2
sys.path.append(os.path.join("/home/katherine/Documents/TGDP_Code/The-Great-Diplomacy-Program/data/Data_Set_3"))
from Commanders_3 import cmdrs_3
from Commands_3 import cmds_3a, cmds_3b
from Units_3 import units_3a, units_3b
sys.path.append(os.path.join("/home/katherine/Documents/TGDP_Code/The-Great-Diplomacy-Program/data/Data_Set_4"))
